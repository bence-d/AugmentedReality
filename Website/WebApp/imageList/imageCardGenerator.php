    ...
    function generateImageBox($imageLocation, $id) {
        ...
        <div class=\"imageHolder\">
            ...
            <div class=\"imageHolder_buttonBar\">
                <button class=\"imageHolder_button\"><img class=\"buttonIcon\" src=\"/Icons/eye.png\" onclick=\"window.location.replace('/imageViewer/?id=" . $id . "')\"></button>
                <button class=\"imageHolder_button\"><img class=\"buttonIcon\" src=\"/Icons/pen.png\" onclick=\"window.location.replace('/imageTaggingNew/?id=" . $id ."')\"></button>
